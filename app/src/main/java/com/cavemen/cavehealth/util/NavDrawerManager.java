...
import com.cavemen.cavehealth.ui.widget.ScrimInsetsScrollView;
...
public class NavDrawerManager {
    ...
    public static final int NAVDRAWER_ITEM_MY_CAVE = 0;
    public static final int NAVDRAWER_ITEM_NEWS = 1;
    public static final int NAVDRAWER_ITEM_ACTIVITY_HISTORY = 2;
    public static final int NAVDRAWER_ITEM_GROUP_ACTIVITIES = 3;
    public static final int NAVDRAWER_ITEM_MY_PROFILE = 4;

    public static final int NAVDRAWER_ITEM_FIND_A_PEER = 5;
    public static final int NAVDRAWER_ITEM_PVP = 6;
    ...
    private static final int[] NAVDRAWER_TITLE_RES_ID = new int[]{
            R.string.navdrawer_item_my_cave,
            R.string.navdrawer_item_news,
            R.string.navdrawer_item_activity_history,
            R.string.navdrawer_item_group_activities,
            R.string.navdrawer_item_my_profile,
            R.string.navdrawer_item_find_a_peer,
            R.string.navdrawer_item_pvp,
            R.string.navdrawer_item_settings
    };
    // icons for navdrawer items (indices must correspond to above array)
    private static final int[] NAVDRAWER_ICON_RES_ID = new int[]{
            R.drawable.ic_drawer_my_cave,  // My Cave
            R.drawable.ic_drawer_news,  // News
            R.drawable.ic_drawer_activity_history,
            R.drawable.ic_drawer_group_activities, //Group activities
            R.drawable.ic_drawer_my_profile, //My Profile
            R.drawable.ic_drawer_find_a_peer,
            R.drawable.ic_drawer_item_pvp,
    ...
    private void populateNavDrawer() {
        ...
        mNavDrawerItems.add(NAVDRAWER_ITEM_MY_CAVE);

        mNavDrawerItems.add(NAVDRAWER_ITEM_NEWS);
        mNavDrawerItems.add(NAVDRAWER_ITEM_ACTIVITY_HISTORY);
        mNavDrawerItems.add(NAVDRAWER_ITEM_GROUP_ACTIVITIES);
        mNavDrawerItems.add(NAVDRAWER_ITEM_MY_PROFILE);

        // Other items that are always in the nav drawer
        mNavDrawerItems.add(NAVDRAWER_ITEM_SEPARATOR_SPECIAL);
        mNavDrawerItems.add(NAVDRAWER_ITEM_FIND_A_PEER);
        mNavDrawerItems.add(NAVDRAWER_ITEM_PVP);
